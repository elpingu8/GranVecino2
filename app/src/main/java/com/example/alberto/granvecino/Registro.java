...
public class Registro extends AppCompatActivity {
    ...
    EditText Email_Registro, Contraseña_Registro, Repetir_Contraseña_Registro, Email_re;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Email_re = (EditText) findViewById(R.id.re_email);
        ...
        botonRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Email_Registro.getText().toString().equals("") || Contraseña_Registro.getText().toString().equals("") || Repetir_Contraseña_Registro.getText().toString().equals("")){
